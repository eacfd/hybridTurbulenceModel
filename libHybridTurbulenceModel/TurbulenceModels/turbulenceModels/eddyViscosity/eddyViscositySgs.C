...
Foam::eddyViscositySgs<BasicTurbulenceModel>::eddyViscositySgs
(
    const word& type,
...
:
    ...
    (
        IOobject
        (
            IOobject::groupName("nuSgs", alphaRhoPhi.group()),
...
template<class BasicTurbulenceModel>
bool Foam::eddyViscositySgs<BasicTurbulenceModel>::read()
{
...
Foam::eddyViscositySgs<BasicTurbulenceModel>::R() const
{
...
template<class BasicTurbulenceModel>
void Foam::eddyViscositySgs<BasicTurbulenceModel>::validate()
{
    correctNut();
}
...
template<class BasicTurbulenceModel>
void Foam::eddyViscositySgs<BasicTurbulenceModel>::correct()
{
