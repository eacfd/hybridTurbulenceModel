...
Foam::eddyViscosityHybrid<BasicTurbulenceModel>::eddyViscosityHybrid
(
    const word& type,
...
:
    ...
    (
        IOobject
        (
            IOobject::groupName("mutualNut", alphaRhoPhi.group()),
...
template<class BasicTurbulenceModel>
bool Foam::eddyViscosityHybrid<BasicTurbulenceModel>::read()
{
...
Foam::eddyViscosityHybrid<BasicTurbulenceModel>::R() const
{
...
template<class BasicTurbulenceModel>
void Foam::eddyViscosityHybrid<BasicTurbulenceModel>::validate()
{
    correctNut();
}
...
template<class BasicTurbulenceModel>
void Foam::eddyViscosityHybrid<BasicTurbulenceModel>::correct()
{
